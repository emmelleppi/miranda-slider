      ...
      function f(e) {
        var t = e.noInfinite,
          ...
          H = Object(u.useState)(function () {
            return Array.from(P.querySelectorAll('[data-slider-image]'))[0].getBoundingClientRect().width
          }),
          B = Object(i.a)(H, 2),
          W = B[0],
          z = B[1],
          ...
          V = Object(o.useSprings)(F.length, function (e) {
            return { x: (e < F.length - 1 ? e : -1) * W + 0, config: q }
          }),
          Z = Object(i.a)(V, 2),
          $ = Z[0],
          ee = Z[1],
          ...
          re = Object(u.useCallback)(
            function (e, n, r, c, a, i, u, o) {
              o ||
                (r &&
                  (u > W / 2 || Math.abs(n) > 1) &&
                  (!t || (t && ((k > 1 && c > 0) || (k < F.length && c < 0)))
                    ? a((ne.current = ne.current + (c > 0 ? -1 : 1)))
                    : a())),
                ne.current + 1 > F.length
                  ? M((ne.current % F.length) + 1)
                  : ne.current < 0
                  ? M(F.length + ((ne.current + 1) % F.length))
                  : M(ne.current + 1)
              var l = ne.current * W,
                s = K(Math.floor(l / W) % F.length),
                d = n < 0 ? F.length - w - 1 : 1
              ee(function (e) {
                var t = Q(e, s, d),
                  c = Q(e, te.current[0], te.current[1]),
                  a = s - (l < 0 ? F.length : 0) + t - d + (l < 0 && 0 === s ? F.length : 0)
                return {
                  x: (-l % (W * F.length)) + W * a + (r ? i : 0) + 0,
        ...
        Object(u.useEffect)(
          ...
          Object(u.useEffect)(
            function () {
              b && (X[k - 1] && (b.innerHTML = X[k - 1] || ''), Y[k - 1] && ((b.innerHTML = ''), b.append(Y[k - 1])))
            },
            [D, Y, T, k, b, X]
          ),
          Object(u.useEffect)(
            function () {
              t &&
                ...
                j && (k === F.length ? j.classList.add('disabled') : j.classList.remove('disabled')))
            },
            [t, k, m, j, F.length]
          ),
          Object(u.useEffect)(
            function () {
              if (m) {
                var e = function (e) {
                  e.stopPropagation(),
                    e.preventDefault(),
                    ((t && k > 1) || !t) && ((ne.current += -1), re(0, -1, !0, -0, function () {}, -0, 0, !0))
                }
                return (
            ...
            function () {
              if (j) {
                var e = function (e) {
                  e.stopPropagation(),
                    e.preventDefault(),
                    (!t || (k < F.length && t)) && ((ne.current += 1), re(0, 1, !0, -0, function () {}, -0, 0, !0))
                }
                return (
        ...
        return (
          ...
          Object(d.jsx)(
            'div',
            Object(a.a)(
              Object(a.a)({ ref: A, className: P.className }, ce()),
              {},
              {
...
//# sourceMappingURL=main.ac1b06dd.chunk.js.map
