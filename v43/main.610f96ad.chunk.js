    ...
    41: function (e, t, n) {
      ...
      function f(e) {
        var t = e.noInfinite,
          ...
          I = void 0 === w ? 1 : w,
          A = Object(u.useRef)(),
          L = Object(u.useState)(window.innerWidth),
          N = Object(i.a)(L, 2),
          k = N[0],
          M = N[1],
          ...
          z = v,
          U = Object(u.useState)(function () {
            var e = Array.from(z.querySelectorAll('[data-slider-image]')),
              t = Array.from(z.getElementsByTagName('a')).map(function (e) {
                return e.attributes
              }),
              n = e.map(function (e) {
              ...
              a = Array.from(z.querySelectorAll('[data-slider-image-content]'))
            return (
              (z.style.display = 'none'), (z.innerHTML = ''), { items: n, classes: r, desc: c, content: a, links: t }
            )
          }),
          _ = Object(i.a)(U, 1)[0],
          F = _.items,
          ...
          K = Object(u.useCallback)(
            function (e) {
              var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : F.length
              return (e < 0 ? e + t : e) % t
            },
            [F]
          ),
          ...
          V = Object(o.useSprings)(F.length, function (e) {
            return { x: (e < F.length - 1 ? e : -1) * k + 0, config: W }
          }),
          Z = Object(i.a)(V, 2),
          $ = Z[0],
          ee = Z[1],
          te = Object(u.useRef)([0, 1]),
          ne = Object(u.useRef)(0),
          re = Object(u.useCallback)(
            function (e, n, r, c, a, i, u, o) {
              o ||
                (r &&
                  (u > k / 2 || Math.abs(n) > 1) &&
                  (!t || (t && ((R > 1 && c > 0) || (R < F.length && c < 0)))
                    ? a((ne.current = ne.current + (c > 0 ? -1 : 1)))
                    : a())),
                ne.current + 1 > F.length
                  ? T((ne.current % F.length) + 1)
                  : ne.current < 0
                  ? T(F.length + ((ne.current + 1) % F.length))
                  : T(ne.current + 1)
              var s = ne.current * k,
                l = K(Math.floor(s / k) % F.length),
                d = n < 0 ? F.length - I - 1 : 1
              ee(function (e) {
                var t = Q(e, l, d),
                  c = Q(e, te.current[0], te.current[1]),
                  a = l - (s < 0 ? F.length : 0) + t - d + (s < 0 && 0 === l ? F.length : 0)
                return {
                  x: (-s % (k * F.length)) + k * a + (r ? i : 0) + 0,
          ...
          ce = Object(s.b)(
            {
              onDrag: function (e) {
                ...
                if (e.tap) {
                  var s = document.getElementById('slider-link-'.concat(f))
                  s.href && s.href.length > 0 && (window.location.href = s.href)
                }
                n && re(-t, -n, r, c, a, o, u)
              }
            },
        ...
        Object(u.useEffect)(
          ...
          Object(u.useEffect)(
            function () {
              H[R - 1] ||
                B(function (e) {
                  return Object(a.a)(Object(c.a)({}, R - 1, !0), e)
                }),
                g && (g.innerHTML = R > 9 ? R : '0'.concat(R))
            },
            [R, g, H]
          ),
          Object(u.useEffect)(
            function () {
              b && (X[R - 1] && (b.innerHTML = X[R - 1] || ''), Y[R - 1] && ((b.innerHTML = ''), b.append(Y[R - 1])))
            },
            [H, Y, B, R, b, X]
          ),
          Object(u.useEffect)(
            function () {
              t &&
                (m && (1 === R ? m.classList.add('disabled') : m.classList.remove('disabled')),
                j && (R === F.length ? j.classList.add('disabled') : j.classList.remove('disabled')))
            },
            [t, R, m, j, F.length]
          ),
          Object(u.useEffect)(
            function () {
              if (m) {
                var e = function (e) {
                  e.stopPropagation(),
                    e.preventDefault(),
                    ((t && R > 1) || !t) && ((ne.current += -1), re(0, -1, !0, -0, function () {}, -0, 0, !0))
                }
                return (
            ...
            function () {
              if (j) {
                var e = function (e) {
                  e.stopPropagation(),
                    e.preventDefault(),
                    (!t || (R < F.length && t)) && ((ne.current += 1), re(0, 1, !0, -0, function () {}, -0, 0, !0))
                }
                return (
          ...
          Object(u.useEffect)(
            function () {
              var e = A.current.getBoundingClientRect().width
              M(e)
            },
            [M]
          ),
          Object(u.useEffect)(
            function () {
              O && (O.innerHTML = F.length > 9 ? F.length : '0'.concat(F.length))
            },
            [O, F]
          )
        var ae = Object(u.useState)(!1),
          ie = Object(i.a)(ae, 2),
          ue = ie[0],
          oe = ie[1]
        return (
            ...
            function () {
              if (ue && n && n > 0) {
                var e = setInterval(function () {
                  ;(ne.current += 1), re(0, 1, !0, -0, function () {}, -0)
                }, n)
                return function () {
          ...
          Object(d.jsx)(
            'div',
            Object(a.a)(
              Object(a.a)({ ref: A, className: z.className }, ce()),
              {},
              {
                  ...
                  return Object(d.jsx)(
                    o.animated.div,
                    {
                      ...
                      children: Object(d.jsx)(o.animated.div, {
                        ...
                        children: Object(d.jsx)(o.animated.div, {
                          className: ''.concat(J[t]),
                          style: Object(a.a)(Object(a.a)({}, F[t]), {}, { pointerEvents: 'none' })
                        })
                      })
                    },
                    t
              ...
              if (a) R && R(m)
                ...
                if (!l || !((0 === n && E > 0) || (n === x - 1 && E < 0))) {
                  if (t)
                    ...
                    var w = p > 0 ? Y.current : G.current
                    te(function (e) {
                      var t
                      return (
                        (t = {}),
                        Object(c.a)(t, W, E + O),
                        Object(c.a)(t, 'delay', e * p < w * p || e === m ? 0 : Math.abs(w - e) * M),
                        Object(c.a)(t, 'config', function (t) {
                          return t === W && e === m ? L : k
                        }),
                        t
      ...
      function y(e) {
        var t = e.margin,
          ...
          k = Object(u.useMemo)(
            function () {
              return { mass: x, tension: S, friction: I }
            },
            [x, S, I]
          ),
      ...
      window.SlidersInit = function () {
        ...
        Array.from(e).forEach(function (e) {
          var t,
            ...
            s = e.getAttribute('data-slider-switch-init-delay'),
            l = e.getAttribute('data-slider-switch-interval'),
          ...
          Object(r.render)(
            Object(d.jsx)(f, {
              id: u,
              initSwitchDelay: l && s && !b ? parseInt(s, 10) : null,
              switchInterval: l && !b ? parseInt(l, 10) : null,
              noInfinite: b,
              domEl: e,
              descEl: g,
              buttonPrev: O,
        ...
        Array.from(t).forEach(function (e) {
          var t,
            ...
            s = e.hasAttribute('data-slider-no-infinite'),
            l = parseInt(e.getAttribute('data-multi-slider-mass'), 10),
...
//# sourceMappingURL=main.610f96ad.chunk.js.map
